...
function buildSystemPrompt() {
  return [
    ...
    "Ajusta extensión Y desarrollo según el campo 'profundidad' del input. Esta es una instrucción fuerte, no opcional:",
    "- profundidad 'breve': máximo ~280 palabras en total. Una sola idea por campo, frases cortas, sin ejemplos ni rodeos. Ve directo a lo esencial y no desarrolles de más.",
    "- profundidad 'equilibrada': ~450 a 600 palabras. Desarrollo moderado; una imagen o un ejemplo concreto en las secciones clave.",
    "- profundidad 'profunda': apunta a 650 palabras o más, sin relleno ni repetición. Desarrolla CADA sección con más matiz que en 'equilibrada': en tension_psicodinamica nombra el conflicto y su reverso; en lectura_de_la_carta_en_esta_pregunta despliega la escena visual, el eje simbólico y el giro con detalle; en resolucion_simbolica y orientacion_practica ofrece más de un ángulo concreto. Profundiza en vez de resumir.",
